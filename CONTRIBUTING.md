...
<sub>Currently, verification is performed based on this setting. (as of 2026/04/18)</sub><br>
...
<sub>Clone the repository to `~\source\repos\FMP7.nvim` when developing with use this dotfile.</sub><br>
上記dotfileを用いた開発の際は`~\source\repos\FMP7.nvim`にクローンしてください。<br>
  
<sub>In addition, specify the path of the command-line tool in FMP7_CLI_PATH.</sub><br>
また、FMP7_CLI_PATHには、コマンドラインツールのパスを指定してください。<br>
